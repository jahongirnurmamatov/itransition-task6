      ...
      <div className="w-[90%] m-auto py-3">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-4 justify-center items-center relative">
            <button className="py-2 px-6 overflow-hidden text-center hidden hover:bg-[#9553f8] lg:block bg-[#8b3dff] text-white rounded-md">
              Start Slides
            </button>
            <div className="dropdown dropdown-end">
              <div role="button" tabIndex={0} className="avatar cursor-pointer hover:scale-105">
              ...
              <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
                <li><span>John Doe - johndoe@gmail.com</span></li>
